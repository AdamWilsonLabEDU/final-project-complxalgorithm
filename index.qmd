...
```{r tract_data, warning=F, cache=T}
...
```{r county_data, warning=F, cache=T}
...
```{r land_cover_setup, warning=F, cache=T}
...
```{r land_cover_chg_map, warning=F, cache=T}
...
```{r became_distressed_tracts, warning=F, cache=T}
...
```{r improved_tracts, warning=F, cache=T}
...
```{r distressed_chgs_table, warning=F}
...
```{r correlations_distressed, warning=F}
